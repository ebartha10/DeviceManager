...
public class UserBuilder {
    ...
    public static UserDTO fromPersistence(com.platform.device.entities.User givenUser){
        return new UserDTO(givenUser.getId(), givenUser.getEmail(), givenUser.getFullName());
    }

    public static User toEntity(UserDTO givenUserDTO){
        return new User(givenUserDTO.getId(), givenUserDTO.getEmail(), givenUserDTO.getFullName());
    }
}
